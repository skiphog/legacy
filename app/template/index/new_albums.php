...
<tr>
<?php
$im_moderator = $myrow['moderator']? '': 'AND pa.pass = 0';
$my_realstatus = $myrow['real_status']? '': 'AND pa.albvisibility != 3';
$query = "SELECT 
		  u.login,
		  u.gender,
		  pa.aid,
...
while ($row = mysql_fetch_assoc($result)) { $tmp = explode(':', $row['album_thumbnail']); ?>
