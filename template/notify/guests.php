...
<style>
    ...
    .w-time, .w-body{display:table-cell;vertical-align:middle;width:100%}
    .w-time{width:70px;text-align:center;white-space:nowrap;padding-right:5px}
    .look-0{border:1px solid #FFC818 !important;box-shadow:0 0 8px #FF0 !important;-moz-box-shadow:0 0 8px #FF0 !important;-webkit-border-shadow:0 0 8px #FF0 !important;}
</style>
<?php $this->stop(); ?>
